  ...
  <div class="lockscreen-item">
    ...
    <form  action="/admin/forgot/reset" method="post">
      ...
      <div class="input-group">
        ...
        <input type="password" class="form-control" placeholder="Digite a nova senha" name="password" id="despassword">
      
      
        <input type="password" class="form-control" placeholder="Repita sua senha" id="repeatdespassword">
      </div>
      
          <button type="submit" class="btn btn-block btn-default">Alterar senha</button>

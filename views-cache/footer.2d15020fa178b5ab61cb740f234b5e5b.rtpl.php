<?php if(!class_exists('Rain\Tpl')){exit;}?>
  ...
  <footer class="main-footer">
    ...
    <div class="pull-right hidden-xs">
      ...
      Criado por V&aacute;gner Lenon

    </div>

    <!-- Default to the left -->

    <strong>Marca registrada &copy; 2018 <a href="http://www.zware.com.br">ZWare</a>.</strong> Todos os direitos reservados.
...
<script src="\res/admin/bower_components/bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js"></script>

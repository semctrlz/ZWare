  ...
  <div align="center">
    <table class="head-wrap w320 full-width-gmail-android" bgcolor="#f9f8f8" cellpadding="0" cellspacing="0" border="0">
      ...
      <tr class="header-background">
        <td class="header container" align="center">
          <div class="content">
            <span class="brand">
              <a href="https://zware.websiteseguro.com">
                <b>Z</b>Ware Soluções digitais
              </a>
            </span>
          </div>
        </td>
                        ...
                        <table class="body-signature-block">
                          <tr>
                            <td class="body-signature-cell">
                              <p>Caso você não tenha solicitado a alteração de sua senha ignore este email.</p>                              
                            </td>
                          </tr>
                        </table>
                      </td>
      ...
      <tr>
        ...
        <td class="container">
          <div class="content footer-lead">
            <a href="https://zware.websiteseguro.com"><b>Contate-nos</b></a> em caso de dúvidas
          </div>
        </td>
        <td></td>
      </tr>
    ...
    <table class="footer-wrap w320 full-width-gmail-android" bgcolor="#e5e5e5">
      <tr>
        ...
        <td class="container">
          <div class="content">
            <a href="mailto:suporte@zware.com.br">Contato</a>&nbsp;&nbsp;|&nbsp;&nbsp;
            <span class="footer-group">
              <a href="https://www.facebook.com/zwarestudios/">Facebook</a>&nbsp;&nbsp;|&nbsp;&nbsp;
              <a href="http://twitter.com/ZWareStudios">Twitter</a>&nbsp;&nbsp;|&nbsp;&nbsp;
              <a href="mailto:suporte@zware.com.br">Suporte</a>
            </span>
          </div>
        </td>
        <td></td>
